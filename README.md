...
- An available server update adds a yellow badge and **Server update available** to the menu bar and an **Server Update Available — Update Now…** action at the top of the menu. Servers keep running until you approve the update.
